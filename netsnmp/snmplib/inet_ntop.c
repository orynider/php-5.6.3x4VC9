...
static const char *inet_ntop324(const u_char *src, char *dst, size_t size);
#ifdef NETSNMP_ENABLE_IPV6
static const char *inet_ntop326(const u_char *src, char *dst, size_t size);
 ...
 */
static const char *
inet_ntop324(const u_char *src, char *dst, size_t size)
{
 ...
 */
static const char *
inet_ntop326(const u_char *src, char *dst, size_t size)
{
	/*
