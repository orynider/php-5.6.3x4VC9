...
{
  return (namingBitmap[((namePages)[((((const unsigned char *)p)[0]) >> 2) & 7] << 3) + (((((const unsigned char *)p)[0]) & 3) << 1) + (((((const unsigned char *)p)[1]) >> 5) & 1)] & (1 << ((((const unsigned char *)p)[1]) & 0x1F)));
}

static int 
utf8_isName3(const ENCODING *enc, const char *p)
{
  return (namingBitmap[((namePages)[(((((const unsigned char *)p)[0]) & 0xF) << 4) + (((((const unsigned char *)p)[1]) >> 2) & 0xF)] << 3) + (((((const unsigned char *)p)[1]) & 3) << 1) + (((((const unsigned char *)p)[2]) >> 5) & 1)] & (1 << ((((const unsigned char *)p)[2]) & 0x1F)));
}
...
{
  return (namingBitmap[((nmstrtPages)[((((const unsigned char *)p)[0]) >> 2) & 7] << 3) + (((((const unsigned char *)p)[0]) & 3) << 1) + (((((const unsigned char *)p)[1]) >> 5) & 1)] & (1 << ((((const unsigned char *)p)[1]) & 0x1F)));
}

static int 
utf8_isNmstrt3(const ENCODING *enc, const char *p)
{
  return (namingBitmap[((nmstrtPages)[(((((const unsigned char *)p)[0]) & 0xF) << 4) + (((((const unsigned char *)p)[1]) >> 2) & 0xF)] << 3) + (((((const unsigned char *)p)[1]) & 3) << 1) + (((((const unsigned char *)p)[2]) >> 5) & 1)] & (1 << ((((const unsigned char *)p)[2]) & 0x1F)));
}
...
static int 
normal_checkPiTarget(const ENCODING *enc, const char *ptr,
...
static int 
normal_scanCdataSection(const ENCODING *enc, const char *ptr,
                         const char *end, const char **nextTokPtr)
{
...
static int 
normal_charRefNumber(const ENCODING *enc, const char *ptr)
{
  int result = 0;
...
static int 
normal_predefinedEntityName(const ENCODING *enc, const char *ptr,
                             const char *end)
{
  switch ((end - ptr)/1) {
  case 2:
...
static int 
normal_nameMatchesAscii(const ENCODING *enc, const char *ptr1,
                       ...
                       POSITION *pos)
{
  while (ptr < end) {
    ...
    case BT_CR:
      pos->lineNumber++;
      ptr += 1;
      if (ptr != end && (((struct normal_encoding *)(enc))->type[(unsigned char)*(ptr)]) == BT_LF)
        ptr += 1;
      pos->columnNumber = (unsigned)-1;
      break;
    default:
...
static void  little2_toUtf8(const ENCODING *enc, const char **fromP, const char *fromLim, char **toP, const char *toLim) { const char *from; for (from = *fromP; from != fromLim; from += 2) { int plane; unsigned char lo2; unsigned char lo = ((unsigned char)(from)[0]); unsigned char hi = ((unsigned char)(from)[1]); switch (hi) { case 0: if (lo < 0x80) { if (*toP == toLim) { *fromP = from; return; } *(*toP)++ = lo; break; } case 0x1: case 0x2: case 0x3: case 0x4: case 0x5: case 0x6: case 0x7: if (toLim - *toP < 2) { *fromP = from; return; } *(*toP)++ = ((lo >> 6) | (hi << 2) | UTF8_cval2); *(*toP)++ = ((lo & 0x3f) | 0x80); break; default: if (toLim - *toP < 3) { *fromP = from; return; } *(*toP)++ = ((hi >> 4) | UTF8_cval3); *(*toP)++ = (((hi & 0xf) << 2) | (lo >> 6) | 0x80); *(*toP)++ = ((lo & 0x3f) | 0x80); break; case 0xD8: case 0xD9: case 0xDA: case 0xDB: if (toLim - *toP < 4) { *fromP = from; return; } plane = (((hi & 0x3) << 2) | ((lo >> 6) & 0x3)) + 1; *(*toP)++ = ((plane >> 2) | UTF8_cval4); *(*toP)++ = (((lo >> 2) & 0xF) | ((plane & 0x3) << 4) | 0x80); from += 2; lo2 = ((unsigned char)(from)[0]); *(*toP)++ = (((lo & 0x3) << 4) | ((((unsigned char)(from)[1]) & 0x3) << 2) | (lo2 >> 6) | 0x80); *(*toP)++ = ((lo2 & 0x3f) | 0x80); break; } } *fromP = from; }
static void  little2_toUtf16(const ENCODING *enc, const char **fromP, const char *fromLim, unsigned short **toP, const unsigned short *toLim) { if (fromLim - *fromP > ((toLim - *toP) << 1) && (((unsigned char)(fromLim - 2)[1]) & 0xF8) == 0xD8) fromLim -= 2; for (; *fromP != fromLim && *toP != toLim; *fromP += 2) *(*toP)++ = (((unsigned char)(*fromP)[1]) << 8) | ((unsigned char)(*fromP)[0]); }
...
static void  big2_toUtf8(const ENCODING *enc, const char **fromP, const char *fromLim, char **toP, const char *toLim) { const char *from; for (from = *fromP; from != fromLim; from += 2) { int plane; unsigned char lo2; unsigned char lo = ((unsigned char)(from)[1]); unsigned char hi = ((unsigned char)(from)[0]); switch (hi) { case 0: if (lo < 0x80) { if (*toP == toLim) { *fromP = from; return; } *(*toP)++ = lo; break; } case 0x1: case 0x2: case 0x3: case 0x4: case 0x5: case 0x6: case 0x7: if (toLim - *toP < 2) { *fromP = from; return; } *(*toP)++ = ((lo >> 6) | (hi << 2) | UTF8_cval2); *(*toP)++ = ((lo & 0x3f) | 0x80); break; default: if (toLim - *toP < 3) { *fromP = from; return; } *(*toP)++ = ((hi >> 4) | UTF8_cval3); *(*toP)++ = (((hi & 0xf) << 2) | (lo >> 6) | 0x80); *(*toP)++ = ((lo & 0x3f) | 0x80); break; case 0xD8: case 0xD9: case 0xDA: case 0xDB: if (toLim - *toP < 4) { *fromP = from; return; } plane = (((hi & 0x3) << 2) | ((lo >> 6) & 0x3)) + 1; *(*toP)++ = ((plane >> 2) | UTF8_cval4); *(*toP)++ = (((lo >> 2) & 0xF) | ((plane & 0x3) << 4) | 0x80); from += 2; lo2 = ((unsigned char)(from)[1]); *(*toP)++ = (((lo & 0x3) << 4) | ((((unsigned char)(from)[0]) & 0x3) << 2) | (lo2 >> 6) | 0x80); *(*toP)++ = ((lo2 & 0x3f) | 0x80); break; } } *fromP = from; }
static void  big2_toUtf16(const ENCODING *enc, const char **fromP, const char *fromLim, unsigned short **toP, const unsigned short *toLim) { if (fromLim - *fromP > ((toLim - *toP) << 1) && (((unsigned char)(fromLim - 2)[0]) & 0xF8) == 0xD8) fromLim -= 2; for (; *fromP != fromLim && *toP != toLim; *fromP += 2) *(*toP)++ = (((unsigned char)(*fromP)[0]) << 8) | ((unsigned char)(*fromP)[1]); }
...
static int 
little2_checkPiTarget(const ENCODING *enc, const char *ptr,
                      const char *end, int *tokPtr)
{
  int upper = 0;
  *tokPtr = 11;
...
static int 
little2_scanCdataSection(const ENCODING *enc, const char *ptr,
                         const char *end, const char **nextTokPtr)
{
  static const char CDATA_LSQB[] = { 0x43, 0x44, 0x41,
                                     0x54, 0x41, 0x5B };
                  ...
                  const char **nextTokPtr)
{
  ...
  case BT_COLON:
    ...
    break;
  case BT_NONASCII:
    if ((namingBitmap[(nmstrtPages[(unsigned char)ptr[1]] << 3) + (((unsigned char)ptr[0]) >> 5)] & (1 << (((unsigned char)ptr[0]) & 0x1F)))) {
      ptr += 2;
      tok = 18;
      break;
    }
    if ((namingBitmap[(namePages[(unsigned char)ptr[1]] << 3) + (((unsigned char)ptr[0]) >> 5)] & (1 << (((unsigned char)ptr[0]) & 0x1F)))) {
      ptr += 2;
      tok = 19;
      break;
    }
...
static int 
little2_charRefNumber(const ENCODING *enc, const char *ptr)
{
  int result = 0;
...
static int 
little2_predefinedEntityName(const ENCODING *enc, const char *ptr,
                             const char *end)
{
  switch ((end - ptr)/2) {
  case 2:
...
static int 
little2_nameMatchesAscii(const ENCODING *enc, const char *ptr1,
                         const char *end1, const char *ptr2)
{
                       ...
                       POSITION *pos)
{
  while (ptr < end) {
    ...
    case BT_CR:
      pos->lineNumber++;
      ptr += 2;
      if (ptr != end && ((ptr)[1] == 0 ? ((struct normal_encoding *)(enc))->type[(unsigned char)*(ptr)] : unicode_byte_type((ptr)[1], (ptr)[0])) == BT_LF)
        ptr += 2;
      pos->columnNumber = (unsigned)-1;
      break;
    default:
...
static int 
big2_checkPiTarget(const ENCODING *enc, const char *ptr,
                      const char *end, int *tokPtr)
{
  int upper = 0;
  *tokPtr = 11;
               ...
               const char *end, const char **nextTokPtr)
{
  ...
  if (ptr == end)
    return -1;
  switch (((ptr)[0] == 0 ? ((struct normal_encoding *)(enc))->type[(unsigned char)(ptr)[1]] : unicode_byte_type((ptr)[0], (ptr)[1]))) {
  case BT_NONASCII: if (!(namingBitmap[(nmstrtPages[(unsigned char)ptr[0]] << 3) + (((unsigned char)ptr[1]) >> 5)] & (1 << (((unsigned char)ptr[1]) & 0x1F)))) { *nextTokPtr = ptr; return 0; } case BT_NMSTRT: case BT_HEX: ptr += 2; break; case BT_LEAD2: if (end - ptr < 2) return -2; if (!(0)) { *nextTokPtr = ptr; return 0; } ptr += 2; break; case BT_LEAD3: if (end - ptr < 3) return -2; if (!(0)) { *nextTokPtr = ptr; return 0; } ptr += 3; break; case BT_LEAD4: if (end - ptr < 4) return -2; if (!(0)) { *nextTokPtr = ptr; return 0; } ptr += 4; break;
  default:
    *nextTokPtr = ptr;
    return 0;
  }
...
static int 
big2_scanCdataSection(const ENCODING *enc, const char *ptr,
                         const char *end, const char **nextTokPtr)
{
  static const char CDATA_LSQB[] = { 0x43, 0x44, 0x41,
                                     0x54, 0x41, 0x5B };
                  ...
                  const char **nextTokPtr)
{
  ...
  case BT_COLON:
    ...
    break;
  case BT_NONASCII:
    if ((namingBitmap[(nmstrtPages[(unsigned char)ptr[0]] << 3) + (((unsigned char)ptr[1]) >> 5)] & (1 << (((unsigned char)ptr[1]) & 0x1F)))) {
      ptr += 2;
      tok = 18;
      break;
    }
    if ((namingBitmap[(namePages[(unsigned char)ptr[0]] << 3) + (((unsigned char)ptr[1]) >> 5)] & (1 << (((unsigned char)ptr[1]) & 0x1F)))) {
      ptr += 2;
      tok = 19;
      break;
    }
...
static int 
big2_charRefNumber(const ENCODING *enc, const char *ptr)
{
  int result = 0;
...
static int 
big2_predefinedEntityName(const ENCODING *enc, const char *ptr,
                             const char *end)
{
  switch ((end - ptr)/2) {
  case 2:
...
static int 
big2_nameMatchesAscii(const ENCODING *enc, const char *ptr1,
                         const char *end1, const char *ptr2)
{
  for (; *ptr2; ptr1 += 2, ptr2++) {
    if (ptr1 == end1)
                       ...
                       POSITION *pos)
{
  while (ptr < end) {
    ...
    case BT_CR:
      pos->lineNumber++;
      ptr += 2;
      if (ptr != end && ((ptr)[0] == 0 ? ((struct normal_encoding *)(enc))->type[(unsigned char)(ptr)[1]] : unicode_byte_type((ptr)[0], (ptr)[1])) == BT_LF)
        ptr += 2;
      pos->columnNumber = (unsigned)-1;
      break;
    default:
...
unknown_isName(const ENCODING *enc, const char *p)
{
  ...
  if (c & ~0xFFFF)
    return 0;
  return (namingBitmap[(namePages[c >> 8] << 3) + ((c & 0xFF) >> 5)] & (1 << ((c & 0xFF) & 0x1F)));
}
...
unknown_isNmstrt(const ENCODING *enc, const char *p)
{
  ...
  if (c & ~0xFFFF)
    return 0;
  return (namingBitmap[(nmstrtPages[c >> 8] << 3) + ((c & 0xFF) >> 5)] & (1 << ((c & 0xFF) & 0x1F)));
}
                       ...
                       void *userData)
{
  ...
  for (i = 0; i < 256; i++) {
    ...
    if (c == -1) {
      ...
      if (c > 0xFFFF)
        return 0;
      if ((namingBitmap[(nmstrtPages[c >> 8] << 3) + ((c & 0xff) >> 5)] & (1 << ((c & 0xff) & 0x1F))))
        e->normal.type[i] = BT_NMSTRT;
      else if ((namingBitmap[(namePages[c >> 8] << 3) + ((c & 0xff) >> 5)] & (1 << ((c & 0xff) & 0x1F))))
...
static const ENCODING *encodingsNS[] = {
