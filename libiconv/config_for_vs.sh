...
WindowsCrtIncludeDir='C:\Program Files\Windows Kits\7.1\Include\um\'
WindowsCrtLibDir='C:\Program Files\Windows Kits\7.1\Lib\'
...
WindowsSdkIncludeDir='C:\Program Files\Windows Kits\8.1\Include\'
WindowsSdkLibDir='C:\Program Files\Windows Kits\8.1\Lib\winv6.3\um\'
...
if [ "${_VS2017}" -eq 1 ]; then
  ...
  if [ "${_VS2008}" -eq 1 ]; then
    ...
    VSINSTALLDIR='C:\MsVS10\'
  elif [ "${_VS2012}" -eq 1 ]; then
