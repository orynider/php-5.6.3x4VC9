...
**	Copyright  Sybase, Inc. 1992, 1997
**	All rights reserved
*/
...
/* 
** define CS_VERSION_120 as CS_VERSION_110
#define CS_VERSION_120		(CS_INT)120
*/
#ifndef		CS_VERSION_120
#define		CS_VERSION_120	CS_VERSION_110
#endif		/* CS_VERSION_120 */


#define CS_CURRENT_VERSION	CS_VERSION_125
...
#define CS_RESTORE_OPEN		(CS_INT)0x8	/* CT-Lib only */
#define CS_MORE			(CS_INT)0x10
#define CS_END			(CS_INT)0x20
#define CS_IMPLICIT_CURSOR	(CS_INT)0x40	/* Added for implicit cursor */
...
*/
#define CS_IMPCURSTAT_NONE		(CS_INT)0x0
#define CS_IMPCURSTAT_READROWS		(CS_INT)0x1
#define CS_IMPCURSTAT_CLOSED		(CS_INT)0x2
#define CS_IMPCURSTAT_SENDSUCCESS	(CS_INT)0x4
#define CS_IMPCURSTAT_SENDDONE		(CS_INT)0x8
...
#define CS_MAX_OPTION           CS_OPT_SORTMERGE
...
#define CS_MAX_REQ_CAP		CS_DATA_UCHAR
