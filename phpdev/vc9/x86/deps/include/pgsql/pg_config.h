...
#define PG_VERSION_STR "PostgreSQL 8.3.3, compiled by Visual C++ build " __STRINGIFY2(_MSC_VER)
...
#define HAVE_LIBXML2
#define USE_LIBXML
#define VAL_CONFIGURE "--enable-thread-safety --with-ldap --with-ossp-uuid --with-libxml --with-libxslt --with-tcl --with-perl --with-python"
