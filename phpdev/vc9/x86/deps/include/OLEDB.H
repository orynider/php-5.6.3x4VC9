...
enum DBROWSTATUSENUM26
    {	DBROWSTATUS_S_ROWSETCOLUMN	= 21
    };
...
#define DBPROPVAL_OS_RESETALL							0x00000010L
#define DBPROPVAL_RD_RESETSERVER							0x00000001L
...
void __RPC_STUB IViewSort_GetSortOrder_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
void __RPC_STUB IViewFilter_GetFilterBindings_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
