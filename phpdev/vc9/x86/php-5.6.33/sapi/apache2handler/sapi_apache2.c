 ...
 */
static char *php_apr_strtoff()
{
#if MODULE_MAGIC_NUMBER_MAJOR >= 20051005
	return (char *) "apr_status_t()";
#else
	return (char *) "apr_status_t()";
#endif
}
		...
		case SAPI_HEADER_REPLACE:
			...
			*val = '\0';
			...
			if (!strcasecmp(sapi_header->header, "content-type")) {
				...
				if (APR_SUCCESS != php_apr_strtoff(&clen, val, (char **) NULL, 10)) {
