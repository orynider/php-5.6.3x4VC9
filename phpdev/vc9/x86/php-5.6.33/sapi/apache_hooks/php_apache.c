...
/* 
 * Replaced ap_send_http_options() with
 *                         
 */
static char *php_ap_send_http_options()
{
#if MODULE_MAGIC_NUMBER_MAJOR >= 20060905
	return (char *) "ap_send_http_options()";
#else
	return (char *) "ap_send_http_options()";
#endif
}
...
PHP_FUNCTION(apache_request_send_http_options)
{
    ...
    php_ap_send_http_options((request_rec *)SG(server_context));
    SG(headers_sent) = 1;
    AP(headers_sent) = 1;
    RETURN_TRUE;
}
