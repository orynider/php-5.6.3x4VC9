...
//static char *_libiconv_version;
//_libiconv_version = strdup(_LIBICONV_VERSION);
//extern LIBICONV_API int _libiconv_version; /* Likewise */
extern LIBICONV_API int strdup(static char *_libiconv_version); /* Likewise */
...
extern LIBICONV_API void libiconv_set_relocation_prefix (const char *orig_prefix, const char *curr_prefix);
//#endif
